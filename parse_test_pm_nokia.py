...
def initialize():
    ...
    file = 'data_e_pm/A20230221.0700 0530-0715 0530_SubNetwork=Maha,SubNetwork=LTE,SubNetwork=BaseBand,MeContext=LNSK207,ManagedElement=LNSK207_statsfile.xml'
    xml_file_names = file
